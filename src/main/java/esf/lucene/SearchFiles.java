...
public class SearchFiles {
	 ...
	 * 
	 */
	private List<SearchResult> doPagingSearch(String value) throws ParseException, IOException {
...
//		searchResults.get(0).preamble = searcher.doc(hits[0].doc);
	...
	public synchronized SearchResult randomResult() throws IOException {
